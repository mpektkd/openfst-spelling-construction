...
fstcompile --isymbols=../vocab/chars.syms --osymbols=../vocab/chars.syms --keep_isymbols --keep_osymbols ../fsts/cit.fst | fstcompose - ../fsts/LVW.binfst | fstshortestpath > shortest_cit.binfst
fstdraw shortest_cit.binfst > shortest_cit.dot
dot -Tpdf -oshortest_cit_LVW.pdf shortest_cit.dot
...
fstcompile --isymbols=../vocab/chars.syms --osymbols=../vocab/chars.syms --keep_isymbols --keep_osymbols ../fsts/cwt.fst | fstcompose - ../fsts/LVW.binfst | fstshortestpath > shortest_cwt.binfst 
fstdraw shortest_cwt.binfst > shortest_cwt.dot
dot -Tpdf -oshortest_cwt_LVW.pdf shortest_cwt.dot
